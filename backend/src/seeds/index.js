...
const products = [
  ...
  },
  {
    ...
    description:
      "A gripping pyschological thriller that will keep you on the edge of your seat. New York Times bestseller with over 1 million copies sold.",
    price: 24.99,
    stock: 100,
    category: "Books",
    images: [
  ...
  {
    name: "Portable Bluetooh Speaker",
    description:
  ...
  },
  {
    ...
    description:
      "Timeless denim jacket with vintage wash and comfortable fit. A wardrobe essential that paris perfectly with any outfit.",
    price: 69.99,
    stock: 40,
    category: "Fashion",
    images: [
  ...
  },
  {
    ...
    description:
      "Gaming keyboard wtih customizable RGB lighting, mechanical switches, and porgrammable keys. Built for gamers and typing enthusiasts.",
    price: 119.99,
    stock: 30,
    category: "Electronics",
    images: [
  ...
  },
  {
    ...
    description:
      "Stunning photography book featuring architecture and desing from around the world. Hardcover edition with 300+ pages of inspiration.",
    price: 39.99,
    stock: 55,
    category: "Books",
    images: [
